...
if(!$ttable){
	...
	echo ('<div style="position: fixed; bottom: 0px; left: 0px; width: 100%; height:7.5%; background-color: rgb(39,40,34); text-align: right; vertical-align: middle; line-height: 200%;  ">Hora Local / Local Time : '.date("H:i").' &nbsp; </div>');



	echo '<table border="0" cellpadding="1" cellspacing="10" width="100%">';
	echo '<tr>';
	echo '<td style=text-align:center;>Llegadas      /      Arrivals</td>';	
	echo '</tr>';
	echo '</table>';
	...
	echo '<td>Hora De llegada <br> Arrival Time </br></td>';
	echo '<td>Carrusel <br>Belt</br></td>';
