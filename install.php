...
$sql = "CREATE TABLE `fids`.`airlines` ( `airlinecode` VARCHAR(3) NOT NULL , `airlinename` TEXT NOT NULL , PRIMARY KEY (`airlinecode`)) ENGINE = InnoDB;";

if ($conn->query($sql) === TRUE) {
    echo "<br>Tabla Airlines Creada Satisfactoriamente";
} else {
...
if ($conn->query($sql) === TRUE) {
    echo "<br>Tabla Airports Creada Satisfactoriamente";
} else {
...
if ($conn->query($sql) === TRUE) {
    echo "<br>Tabla Arrivals Creada Satisfactoriamente";
} else {
...
if ($conn->query($sql) === TRUE) {
    echo "<br>Tabla Departures creada Satisfactoriamente";
} else {
...
if ($conn->query($sql) === TRUE) {
    ...
    echo "<br><br><h1>Configuracion completada<br><br>It's se recomienta borrar este archivo!</h1>";
} else {
