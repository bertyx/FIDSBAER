...
if(!$ttable){
	...
	echo('<p>Oops, Intente Nuevamente</p>');
} else {
	...
	echo '<td>EDT</td>';
	echo '<td>Puerta</td>';
	echo '<td>Hora para el CheckIn</td>';
	echo '<td>Estado</td>';
	echo '<td>Tipo</td>';
	echo '<td>Mensaje a AVSEC</td>';
	echo '<td><a href="depnewdeparture.php"><button>Nueva Salida</button></a></td>';
	echo '<td><a href="index.html"><button>Pagina de Inicio</button></a></td>';
	echo '</tr>';
	...
	if ($login=='y') {
		echo '<td><input type="submit" value="Actualizar Vuelo" name="updateflight"></td>';
	}
	...
	if ($login=='y') {
		echo '<td><input type="submit" value="Borrar Vuelo" name="deleteflight"></td>';
	}
